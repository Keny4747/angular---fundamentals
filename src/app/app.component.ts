...
export class AppComponent {
  ...
  person = {
    name:'nicolas',
    age: 28,
    avatar:'https://cdn-icons-png.flaticon.com/512/6073/6073874.png'
  }

  names : string[] = ['Keny','Carlos','Santi'];
  newName = "";

  //Product es una interface que establece que atributos tendrña nuesto arreglo
  products : Product[] = [
    {
  ...
  onScroll(event: Event){
    //el evento target se va a comportar como un Html
  ...
  changeName(event: Event){
    ...
    this.person.name=element.value;//value nos permite saber el valor actual
  }
  ...
  deleteName(index: number){
    //splice permite eliminar un valor del array a partir de un indice
    //(index, 1): desde indice hasta que elemento eliminar, solo queremos uno
